<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\TP5\twothink\public/../application/admin/view/default/rs\index.html";i:1534088147;s:73:"D:\TP5\twothink\public/../application/admin/view/default/public\base.html";i:1534055821;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $rs['id']; ?>"> </td>
						<td><?php echo $rs['id']; ?></td>
						<td><a href="<?php echo url('index?pid='.$rs['id']); ?>"><img class="img-thumbnail" src="__ROOT__<?php echo get_cover_path($rs['logo']); ?>"/></a></td>
                        <td><?php echo $rs['title']; ?></td>
                        <td><?php echo $rs['content']; ?></td>
                        <td><?php echo $rs['price']; ?></td>
                        <td><?php echo time_format($rs['create_time']); ?></td>
                        <td><?php echo $rs['deadline']; ?></td>
                        <td><?php echo !empty($rs['status'])?'出售' : '出租'; ?></td>
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$rs['id'].'&pid='.$pid); ?>">编辑</a>

							<a class="confirm" title="删除" href="<?php echo url('del?id='.$rs['id']); ?>">删除</a>
						</td>
					</tr>
