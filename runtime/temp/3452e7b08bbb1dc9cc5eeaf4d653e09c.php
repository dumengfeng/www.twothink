...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sign): $mod = ($i % 2 );++$i;?>
					<tr>
                        ...
                        <td><?php echo time_format($sign['update_time']); ?></td>
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$sign['id'].'&pid='.$pid); ?>">编辑</a>

							<a class="confirm" title="删除" href="<?php echo url('del?id='.$sign['id']); ?>">删除</a>
						</td>
					</tr>
