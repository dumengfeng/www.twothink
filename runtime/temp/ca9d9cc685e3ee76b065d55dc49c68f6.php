<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\TP5\twothink\public/../application/admin/view/default/repair\index.html";i:1533800003;s:73:"D:\TP5\twothink\public/../application/admin/view/default/public\base.html";i:1534055821;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td><a href="<?php echo url('index?pid='.$channel['id']); ?>"><?php echo $channel['username']; ?></a></td>
						<td><?php echo $channel['phone']; ?></td>
                        ...
                        <td><?php echo time_format($channel['update_time']); ?></td>
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$channel['id'].'&pid='.$pid); ?>">编辑</a>

							<a class="confirm" title="删除" href="<?php echo url('del?id='.$channel['id']); ?>">删除</a>
						</td>
					</tr>
